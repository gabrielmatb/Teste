...
<head>
    ...
    <title>Formulário Remover Rede</title>
    ...
    <div class="container col s12">
        ...
        <div class="row">
            <form action="../PHP/removerRoteador.php" method="post" id="frmRemoverRoteador" name="frmRemoverRoteador" class="col s12">
                ...
                <div class="input-field col s8">
                    <label for="lblIP">IP: <?php echo $ip;?></label>
                </div>
                <div class="input-field col s8">
                    <label for="lblMascara">Máscara: <?php echo $mascara;?></label>
                </div>
                <div class="input-field col s8">
                    <label for="lblVelocidade">Velocidade: <?php echo $velocidade;?></label>
                </div>
